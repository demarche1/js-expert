...
describe('Person', function () {
  ...
  it('Should throw error not pass valid string', () => {
    const stub = sinon.stub(Person, Person.generateInstanceFromString.name)
    stub
      .withArgs('1 Navio, Carro 200000 2009-05-03 2022-06-01')
